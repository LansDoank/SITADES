<x-layout>
    ...
    <div id="hero">
        <div class="container w-full flex h-[700px] md:p-20">
            <div class="w-1/2 flex flex-col justify-center">
                <h1 class="text-klipaa font-poppins text-5xl font-semibold md:my-5 leading-snug">SELAMAT DATANG
                    DI SITAMU !</h1>
                <p class="text-sm text-slate-500 font-medium">Mudah, Cepat, dan Efisien! Buku Tamu Digital membantu
            ...
            <div class="w-1/2 flex justify-end items-center">
                <img class="w-[80%]" src="/img/hero.png" alt="">
            </div>
        </div>
    </div>
        ...
        <div class="container bg-klipaa rounded-2xl flex justify-center flex-col items-center md:p-10">
            ...
            <div class="flex">
                ...
                <div class="w-1/2 flex flex-col justify-center items-start md:p-5">
                    <p class="text-white">SITAMU adalah platform digital yang dirancang khusus untuk mendukung
                        ...
                        berkaitan dengan kegiatan administratif desa <br><br>

                        SITAMU menjadi alat yang sangat efektif untuk meningkatkan efisiensi, transparansi, dan
                        akuntabilitas dalam pengelolaan administrasi desa, serta mendukung kemajuan digitalisasi di
                        tingkat pemerintahan desa.</p>
                    <button class="w-36 bg-white h-14 text-klipaa md:my-5 rounded font-medium">Selengkapnya</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <footer class="w-full text-white bg-klipaa md:px-10 md:pt-8">
